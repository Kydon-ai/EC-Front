...
type MenuItemType = NonNullable<MenuProps['items']>[number] & { key: string; label: React.ReactNode };
			...
			<div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
				<div style={{ display: 'flex', alignItems: 'center', cursor: "pointer" }} onClick={handleClickLogo}>
					...
					<div style={{ zoom: "60%" }}>
						...
						<p style={{ fontSize: '1rem', textAlign: 'justify', margin: 0, fontWeight: 'bolder' }}>基于AntD + Zustand的原生React开发模板<span style={{ display: 'inline-block', width: '0%' }}></span></p>
					</div>
				</div>
				{isHorizontal ? (
